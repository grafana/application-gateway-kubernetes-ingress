...
func (az *FakeAzClient) DeployGatewayWithSubnet(subnetID, skuName string, findPrivateIP, noPublicIP bool, autoscaleMinReplicas, autoscaleMaxReplicas *int32, zones []string, enableHTTP2 bool) (err error) {
...
func (az *FakeAzClient) DeployGatewayWithVnet(resourceGroupName ResourceGroup, vnetName ResourceName, subnetName ResourceName, subnetPrefix, skuName string, findPrivateIP, noPublicIP bool, autoscaleMinReplicas, autoscaleMaxReplicas *int32, zones []string, enableHTTP2 bool) (err error) {
	if az.DeployGatewayFunc != nil {
